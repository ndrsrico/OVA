        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(ssrRenderComponent(VMain, { class: "dynamic-bg position-relative overflow-hidden" }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="floating-shapes" data-v-f57c489c${_scopeId2}><div class="shape shape-1" data-v-f57c489c${_scopeId2}></div><div class="shape shape-2" data-v-f57c489c${_scopeId2}></div><div class="shape shape-3" data-v-f57c489c${_scopeId2}></div><div class="shape shape-4" data-v-f57c489c${_scopeId2}></div><div class="shape shape-5" data-v-f57c489c${_scopeId2}></div></div>`);
                            ...
                            if (_push5) {
                              _push5(ssrRenderComponent(VCol, {
                                ...
                                default: withCtx((_5, _push6, _parent6, _scopeId5) => {
                                  if (_push6) {
                                    _push6(`<div class="text-center mb-8" data-v-f57c489c${_scopeId5}><h1 class="text-h3 font-serif text-white mb-4 slide-fade-in text-glow" data-v-f57c489c${_scopeId5}>ESTRUCTURA CURRICULAR</h1><p class="text-subtitle-1 font-serif-italic text-grey-lighten-2 slide-fade-in-delayed mb-6" data-v-f57c489c${_scopeId5}> Completa cada tema en orden para desbloquear el siguiente. </p></div><div class="progress-section mb-8 pa-6 rounded-xl" style="${ssrRenderStyle({ "background": "rgba(212,175,55,0.08)", "border": "2px solid rgba(212,175,55,0.3)" })}" data-v-f57c489c${_scopeId5}><div class="d-flex justify-space-between align-center mb-3" data-v-f57c489c${_scopeId5}><span class="text-body-1 font-weight-bold text-white" data-v-f57c489c${_scopeId5}>Progreso:</span><span class="text-body-2 text-gold font-weight-bold" data-v-f57c489c${_scopeId5}>${ssrInterpolate(unref(maxTemaDesbloqueado) - 1)} / ${ssrInterpolate(temasData.length)} completados</span></div>`);
                                      ...
                                      _push6(ssrRenderComponent(VCard, {
                                        ...
                                        default: withCtx((_6, _push7, _parent7, _scopeId6) => {
                                          if (_push7) {
                                            ...
                                            }, "state-indicator pa-5 text-center"])}" data-v-f57c489c${_scopeId6}>`);
                                            ...
                                            _push7(`<div class="tema-badge" data-v-f57c489c${_scopeId6}>${ssrInterpolate(index + 1 < unref(maxTemaDesbloqueado) ? "COMPLETADO" : index + 1 === unref(maxTemaDesbloqueado) ? "EN PROGRESO" : "BLOQUEADO")}</div></div>`);
                                            _push7(ssrRenderComponent(VCardText, { class: "flex-grow-1 text-center pa-6" }, {
                                              default: withCtx((_7, _push8, _parent8, _scopeId7) => {
                                                if (_push8) {
                                                  _push8(`<h3 class="tema-title text-h6 mb-3" data-v-f57c489c${_scopeId7}>${ssrInterpolate(tema.titulo)}</h3><p class="text-body-2 text-grey-lighten-2" data-v-f57c489c${_scopeId7}>${ssrInterpolate(tema.descripcion)}</p>`);
                                                } else {
                                                  return [
                                                ...
                                                if (_push8) {
                                                  ...
                                                  return [
                                                    index + 1 <= unref(maxTemaDesbloqueado) ? (openBlock(), createBlock(VBtn, {
                                                      ...
                                                      _: 2
                                                    }, 1032, ["color"])) : (openBlock(), createBlock(VBtn, {
                                                      key: 1,
                                                      color: "grey",
                                                      variant: "outlined",
                                                      disabled: "",
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/Temario-NEW.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};
const TemarioNEW = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-f57c489c"]]);

export { TemarioNEW as default };
//# sourceMappingURL=Temario-NEW-wh3TIFiB.mjs.map
