  ...
  <v-app>
    ...
    <v-main class="dynamic-bg position-relative overflow-hidden">
      ...
      <v-container fluid class="pa-8 position-relative z-1">
        <!-- ===== VISTA BLOQUEADA ===== -->
        <v-row class="mb-8" v-if="maxTemaDesbloqueado < 7">
          <v-col cols="12" md="8" class="mx-auto">
            <v-card elevation="0" class="rounded-xl overflow-hidden glass-card pa-8 text-center">
              <v-icon color="red-accent-2" size="80" class="mb-6">mdi-lock</v-icon>
              <h1 class="text-h3 font-serif text-white mb-4 text-glow">EVALUACIÓN BLOQUEADA</h1>
              <p class="text-subtitle-1 font-serif-italic text-grey-lighten-2 mb-8">
                Aún no estás listo para este desafío. Para desbloquear la evaluación general, debes completar todos los temas de estudio (01 al 05) y revisar el módulo de Recursos (06).
              </p>
              <v-btn
                to="/Temario"
                color="gold-btn"
...
const finalizarEvaluacion = () => {
  ...
  if (maxTemaDesbloqueado.value === 7) {
    maxTemaDesbloqueado.value = 8
