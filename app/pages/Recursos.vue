  ...
  <v-app>
    ...
    <v-main class="dynamic-bg position-relative overflow-hidden">
      ...
      <v-container fluid class="pa-8 position-relative z-1">
        ...
        <v-row class="mt-12">
          <v-col cols="12" md="8" class="mx-auto text-center">
            <v-card variant="outlined" color="gold" class="pa-6 rounded-xl mb-8 glass-card border-opacity-50">
              <v-icon color="gold" size="48" class="mb-4">mdi-clipboard-text</v-icon>
              <h3 class="font-serif text-h5 text-white mb-2">¿Listo para la Evaluación?</h3>
              <p class="text-body-2 text-grey-lighten-2 mb-6">
                Una vez hayas revisado el material de estudio y los recursos complementarios, estarás preparado para tomar la evaluación final del OVA.
              </p>
              <v-btn
                color="gold-btn"
                size="large"
                class="font-weight-bold px-8 hover-btn pulse-animation"
                @click="finalizarRecursos"
                append-icon="mdi-arrow-right"
              >
                Marcar como Leído e Ir a la Evaluación
              </v-btn>
            </v-card>
...
const finalizarRecursos = () => {
  if (maxTemaDesbloqueado.value === 6) {
    maxTemaDesbloqueado.value = 7
